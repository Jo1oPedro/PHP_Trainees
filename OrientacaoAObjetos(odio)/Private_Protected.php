...
class Site extends Post {
    ...
    public function getLikesSite() {
        return $this->getLikes2();
    }
}
...
echo "Numero de likes: " . $site->getLikesSite() . "<br/> <br/>"; // acessa uma função public que tem acesso a respectivamente uma protected e uma private;
